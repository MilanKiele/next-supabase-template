import { Supportmail } from "@/constants/index";
      ...
      <div className="container space-y-8">
        ...
        >
          ...
          <ul>
            ...
            <li>
              <p className="mt-4 text-base text-primary">
                <strong>Application</strong> refers to MaiaLabs, the software
            ...
            <li>
              <p className="mt-4 text-base text-primary">
                ...
                in this Agreement) refers to MaiaLabs.
              </p>
            </li>
            <li>
              <p className="mt-4 text-base text-primary">
            ...
            <li>
              <p className="mt-4 text-base text-primary">
                <strong>Country</strong> refers to: Baden-Württemberg, Germany
              </p>
            </li>
            <li>
              <p className="mt-4 text-base text-primary">
            ...
            <li>
              <p className="mt-4 text-base text-primary">
                <strong>Website</strong> refers to MaiaLabs, accessible from{" "}
                <a
                  href="maialabs.net"
          ...
          <ul>
            <li>
              <p className="mt-4 text-base text-primary">Email address</p>
            </li>
            <li>
              <p className="mt-4 text-base text-primary">Usage Data</p>
            </li>
          </ul>
          <h4>Usage Data</h4>
          <p className="mt-4 text-base text-primary">
          ...
          <ul>
            <li>
              ...
              <p className="mt-4 text-base text-primary">Administered by: Us</p>
              <p className="mt-4 text-base text-primary">
          ...
          <ul>
            <li>By email: support@maialabs.net</li>
          </ul>
        </div>
        {/* Contact Section */}
        <div className="mt-8 pt-8 text-center">
          <p className="subinfo">MaiaLabs, Kölner Str. 354b, 51515 Kürten</p>
          <p className="subinfo">
