...
--
-- Name: posts fk_profile; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.posts
    ADD CONSTRAINT fk_profile FOREIGN KEY (profile_id) REFERENCES public.user_profiles(id) ON DELETE CASCADE;
...
--
-- Name: posts Admins can delete any post; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: user_profiles Admins can update any profile; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Admins can update any profile" ON public.user_profiles FOR UPDATE USING (((auth.uid() = user_id) OR (EXISTS ( SELECT 1
   FROM public.user_profiles user_profiles_1
  WHERE ((user_profiles_1.user_id = auth.uid()) AND (user_profiles_1.role = 'admin'::text)))))) WITH CHECK (((auth.uid() = user_id) OR (EXISTS ( SELECT 1
   FROM public.user_profiles user_profiles_1
  WHERE ((user_profiles_1.user_id = auth.uid()) AND (user_profiles_1.role = 'admin'::text))))));


--
-- Name: posts Blocked users cannot create posts; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Blocked users cannot create posts" ON public.posts FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM public.user_profiles
  WHERE ((user_profiles.user_id = auth.uid()) AND (user_profiles.is_blocked = false)))));
...
--
-- Name: posts Users can access their own posts; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Users can access their own posts" ON public.posts USING ((auth.uid() = ( SELECT user_profiles.user_id
   FROM public.user_profiles
  WHERE (user_profiles.id = posts.profile_id))));


--
-- Name: posts delete_own_post; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY delete_own_post ON public.posts FOR DELETE TO authenticated USING ((profile_id IN ( SELECT user_profiles.id
   FROM public.user_profiles
  WHERE (user_profiles.user_id = auth.uid()))));


--
-- Name: posts insert_own_post; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY insert_own_post ON public.posts FOR INSERT TO authenticated WITH CHECK ((profile_id IN ( SELECT user_profiles.id
   FROM public.user_profiles
  WHERE (user_profiles.user_id = auth.uid()))));
...
--
-- Name: posts select_all_posts; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: posts update_own_post; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY update_own_post ON public.posts FOR UPDATE TO authenticated USING ((profile_id IN ( SELECT user_profiles.id
   FROM public.user_profiles
  WHERE (user_profiles.user_id = auth.uid()))));
